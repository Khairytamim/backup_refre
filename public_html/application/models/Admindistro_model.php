	...
	public function tambah_produk(){
		...
		if($tipe==0){
            ...
            $t38=$this->input->post('t38');
                ...
                if($tipe==0){	
                $this->db->reconnect();
                	$id_produk = $this->db->query("call tambah_produk_tipe0('$nama_produk', '$deskripsi_produk', '$harga', '$id_toko', '$berat', '$produk_kategori', '$gender', '$status_tampil','$tipe','$brand','$id_brand','$discount','$ukuran','$personality')");                
                }else if($tipe==1){
                	$this->db->reconnect();
                	$id_produk = $this->db->query("call tambah_produk_tipe1('$nama_produk', '$deskripsi_produk', '$harga', '$id_toko', '$berat', '$produk_kategori', '$gender', '$status_tampil','$tipe','$brand','$id_brand','$discount','$c1', '$c2', '$c3', '$c4', '$c5', '$c6','$l1', '$l2', '$l3', '$l4', '$l5', '$l6','$s1', '$s2', '$s3', '$s4', '$s5', '$s6','$personality')");
                }else if($tipe==2){
                	$this->db->reconnect();
                	$id_produk = $this->db->query("call tambah_produk_tipe2('$nama_produk', '$deskripsi_produk', '$harga', '$id_toko', '$berat', '$produk_kategori', '$gender', '$status_tampil','$tipe','$brand','$id_brand','$discount','$u36', '$u37', '$u38', '$u39', '$u40', '$u41','$u42', '$u43','$u44','$u45','$u46','$u47','$personality')");
                }else if($tipe==3){
                	$this->db->reconnect();
                	$id_produk = $this->db->query("call tambah_produk_tipe3('$nama_produk', '$deskripsi_produk', '$harga', '$id_toko', '$berat', '$produk_kategori', '$gender', '$status_tampil','$tipe','$brand','$id_brand','$discount','$i27', '$i28', '$i29', '$i30', '$i31', '$i32', '$i33', '$i34','$i35', '$i36','$i37','$i38',
                	'$w27', '$w28', '$w29', '$w30', '$w31', '$w32', '$w33', '$w34','$w35', '$w36','$w37','$w38',
                	'$h27', '$h28', '$h29', '$h30', '$h31', '$h32', '$h33', '$h34','$h35', '$h36','$h37','$h38',
                	'$t27', '$t28', '$t29', '$t30', '$t31', '$t32', '$t33', '$t34','$t35', '$t36','$t37','$t38','$personality'
                	)");
                }
                $this->db->reconnect();
	...
	public function simpan_produk($id_produk){
		...
		if($tipe==0){
			...
			$s2=$this->input->post('s2');
                ...
                if($tipe==0){	
                $this->db->reconnect();
                	$this->db->query("call simpan_produk_tipe0('$id_produk','$nama_produk', '$deskripsi_produk', '$harga','$personality','$berat', '$gender','$brand','$id_brand','$discount','$ukuran')");                
                }else if($tipe==1){
                	$this->db->reconnect();
                	$this->db->query("call simpan_produk_tipe1('$id_produk','$nama_produk', '$deskripsi_produk', '$harga','$personality', '$berat',  '$gender', '$brand','$id_brand','$discount','$c1', '$c2', '$c3', '$c4', '$c5', '$c6','$l1', '$l2', '$l3', '$l4', '$l5', '$l6','$s1', '$s2', '$s3', '$s4', '$s5', '$s6')");
                }else if($tipe==2){
                	$this->db->reconnect();
                	$this->db->query("call simpan_produk_tipe2('$id_produk','$nama_produk', '$deskripsi_produk', '$harga', '$berat', '$gender', '$status_tampil','$brand','$id_brand','$discount','$u36', '$u37', '$u38', '$u39', '$u40', '$u41','$u42', '$u43','$u44','$u45','$u46','$u47')");
                }else if($tipe==3){
                	$this->db->reconnect();
                	$this->db->query("call simpan_produk_tipe3('$id_produk','$nama_produk', '$deskripsi_produk', '$harga','$personality', '$berat', '$gender', '$brand','$id_brand','$discount','$i27', '$i28', '$i29', '$i30', '$i31', '$i32', '$i33', '$i34','$i35', '$i36','$i37','$i38',
                	'$w27', '$w28', '$w29', '$w30', '$w31', '$w32', '$w33', '$w34','$w35', '$w36','$w37','$w38',
                	'$h27', '$h28', '$h29', '$h30', '$h31', '$h32', '$h33', '$h34','$h35', '$h36','$h37','$h38',
        ...
        public function show_personality(){
        	$this->db->reconnect();
	        $hasil=$this->db->query("select nama_personality, id_namaper from namapersonality");
	        return $hasil;
        }
...
'$nomor_teleponowner', '$website', '$alamat_toko', '$email_toko')");
       ...
       public function daftar_pesan($id_){
        	$this->db->reconnect();
                $id_toko = $this->session->userdata('id_toko');
	        $hasil=$this->db->query("select * where id_toko='$id_'");
	        return $hasil;
        }
