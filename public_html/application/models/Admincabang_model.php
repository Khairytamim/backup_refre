...
class Admincabang_model extends CI_Model {
        ...
        public function daftar_pesan_toko($id_){
        	$this->db->reconnect();
            $id_toko = $this->session->userdata('id_toko');
	        $hasil=$this->db->query("select * from billing_detail where id_toko='$id_' ");

	        return $hasil;
        }

	public function daftar_pemesanan_toko($id_cabang,$flag){
		$this->db->reconnect();
		$id_toko = $this->session->userdata('id_toko');
		$hasil=$this->db->query("call daftar_pemesanan_toko('$id_cabang','$flag')");
		return $hasil;
	}

	public function update_resi($id_billing_detail, $nomorresi){
		$this->db->reconnect();
		$hasil=$this->db->query("call update_resi($id_billing_detail,'$nomorresi')");
		return $hasil;
	}
	...
	public function get_id_produk_terakhir($id_toko){
        ...
        public function pemesanan(){
	        ...
	        $hasil=$this->db->query("call pemesanan('$id_toko')");
	        return $hasil;
        }
